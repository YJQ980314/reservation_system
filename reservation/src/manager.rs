...
#[cfg(test)]
mod tests {
    use abi::{Reservation, reservation_service_client::ReservationServiceClient, ReservationConflictInfo};
    ...
    async fn reserve_should_work_for_valid_window() {
        ...
        let rsvp = abi::Reservation::new_pending(
            ...
            "I'll arrive at 3pm. PLease help to upgrade to execuitve rommm if possible",
        );
    ...
    async fn reserve_confilct_reservation_should_reject() {
        ...
        let _rsvp1 = manager.reserve(rsvp1).await.unwrap_err();
